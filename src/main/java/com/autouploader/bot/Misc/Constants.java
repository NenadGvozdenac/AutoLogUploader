...
public class Constants {
    public static HashMap<String, String> listOfEmojisAndBosses = new HashMap<String, String>(){
        {
            ...
            put("Eye of Fate", "<:eyes:1027914717634764851>");
            ...
            put("Captain Mai Trin", "<:maitrin:1027914811713015921>");
            ...
            put("Old Lion", "<:oldlioncourt:1288196772807708712>");
            put("Dagda", "<:dagda:1027914816704245761>");
            put("Cerus", "<:cerus:1288201649973629022>");
    ...
    public static HashMap<String, ArrayList<String>> listOfBossesAndWings = new HashMap<String, ArrayList<String>>(){
        {
            ...
            put("Secrets of the Obscure", new ArrayList<String>() {
                {
                    add("Dagda");
                    add("Cerus");
                }
